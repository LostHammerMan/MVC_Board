...
<nav class="navbar navbar-expand-md bg-dark navbar-dark fixed-top shadow-lg">
	...
	<div class="collapse navbar-collapse" id="navMenu">
		<ul class="navbar-nav">
			<li class="nav-item">
				<a href="board_main.jsp" class="nav-link">자유게시판</a>
			</li>
			<li class="nav-item">
				<a href="board_main.jsp" class="nav-link">유머게시판</a>
			</li>
			<li class="nav-item">
				<a href="board_main.jsp" class="nav-link">정치게시판</a>
			</li>
			<li class="nav-item">
				<a href="board_main.jsp" class="nav-link">스포츠게시판</a>
			</li>
		</ul>
				...
				<div class="card-body">
					...
					<div class="form-group">
						<div class="text-right">
							<a href="board_main.jsp" class="btn btn-primary">목록보기</a>
							<a href="board_modify.jsp" class="btn btn-info">수정하기</a>
							<a href="board_main.jsp" class="btn btn-danger">삭제하기</a>
						</div>
					</div>
				</div>
			</div>

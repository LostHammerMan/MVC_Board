...
<%--									<option value="@nate.co.kr">네이트</option>--%>
<%--									<option value="@daum.net">카카오</option>--%>
<%--								</select>--%>
<%--							</label>--%>
						</div>
						<div class="form-group">
...
<%--									<label for="program" id="programming">프로그래밍</label>--%>
<%--									<form:label path="user_goal">목표 지정</form:label>--%>


<%--							</div>--%>
<%--								<div class="form-check">--%>
<%--									<input type="radio" id="study" name="user_goal" class="form-check-input"/>--%>
<%--									<label for="study" id="nomu">노무사</label>--%>
<%--								</div>--%>
